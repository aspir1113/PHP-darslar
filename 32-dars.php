...
if(isset($_POST['submit']))
{
  ...
  $name_validation="/^[a-zA-Z`]{3,}$/";
  $password_validation="/^[a-zA-Z0-9]{5,}$/";

  if(preg_match($name_validation, $name)&&preg_match($password_validation, $password))
  {
    echo "Hush kelibsiz: $name";
  }
  else
  {
    echo "<b>Xatolik mavjud!</b>";
  }
}
